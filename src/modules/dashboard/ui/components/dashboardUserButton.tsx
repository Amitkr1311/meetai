        ...
        return (
            <Drawer>
                <DrawerTrigger asChild>
                    <Button variant="ghost" className="h-16 rounded-md border-border/10 p-3 w-full flex
                    items-center justify-between bg-white/5 hover:bg-white/10 overflow-hidden gap-2">
                    {data.user.image ? (
                     <Avatar>
